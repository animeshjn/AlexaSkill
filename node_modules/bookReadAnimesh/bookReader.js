...
//Read Whole book
module.exports.readWholeBook=function readWholeBook(accessToken,name,request,response,session,extension,callback){
...
exports.readFromChapter=function readFromChapter(chapterNumber,accessToken,name,request,response,session,extension,callbackLast){
    getBookDataByName(accessToken,name,request,response,session,extension,callbackForArray);
    function callbackForArray(arrayText,bookText){
        //getChapterPhrase
    ...
    function callbackAfterChapter(chaptersArray,index)
    {
        ...
        if(!index)
        {
            response.speechText+="I cannot read that chapter, make sure the book is in right format."
