...
exports.getChapterName=function getChapterName(filePath,chapterNumber,callback){
    ...
    //search
    // string1(.*)endString
    var allContent=module.exports.getAllContent(filePath,manipulate)
    function manipulate(contentData){
        ...
        var canonicalList=contentsIndex.replace(/(\r\n|\r|\n)/g, '\n');
        var array=canonicalIndex.split('\n');
...
exports.contentArray= contents =>{
  // var canonicalContent=contents.replace(/(\r\n|\r|\n)/g, '\n');
    var wholeContentArray=contents.split('\n');
